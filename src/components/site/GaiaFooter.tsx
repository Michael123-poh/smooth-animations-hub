...
import womanImg from "../../assets/Woman Sitting Looking Up.png";
...
const news = [
  { label: "Branding 2025 : les tendances qui dominent", date: "Mai 2025" },
  { label: "Comment une identité visuelle forte change tout", date: "Avr. 2025" },
  { label: "Gaïa remporte le prix du meilleur studio créatif", date: "Mar. 2025" },
];
  ...
  return (
    <footer className="gaia-footer" ref={ref} role="contentinfo">
      ...
      <div className="footer-hero">
        ...
        <p className="footer-tagline" aria-label="Connecting brands to people">
          {"Connecting brands to pe".split("").map((c, i) => (
            <span key={i}>{c}</span>
          ))}
          <span className="footer-tagline-o">O</span>
          {"ple".split("").map((c, i) => (
            <span key={"b" + i}>{c}</span>
          ))}
        </p>
      ...
      <div className="footer-grid">
        ...
        <div className="footer-col footer-col--news">
          <p className="footer-col-heading">Actualités</p>
          <ul className="footer-news">
            {news.map((n, i) => (
              <li key={i} className="footer-news-item">
                <span className="footer-news-date">{n.date}</span>
                <span className="footer-news-label">{n.label}</span>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div className="footer-col footer-col--right">
          ...
          <div className="footer-woman-wrap" aria-hidden="true">
            <img src={womanImg} alt="" className="footer-woman" />
          </div>
        </div>
